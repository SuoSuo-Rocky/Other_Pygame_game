...
# https://github.com/crossin/snippet
...
bg = pygame.transform.scale(bg, (640, 396))
...
for i in range(200):
    x = random.randrange(0, SIZE[0]) # x 坐标
    y = random.randrange(0, SIZE[1]) # y 坐标
    sx = random.randint(-1, 1)
    sy = random.randint(3, 8)       # 半径
